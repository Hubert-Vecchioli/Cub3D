...
/*   Updated: 2024/08/05 13:48:51 by hvecchio         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_free_all(t_game *game)
{
	if (game->window)
	{
		//mlx_mouse_show(game->mlx_ptr, game->window); je retire car ça leak de hide la souris : https://github.com/42Paris/minilibx-linux/issues/48
